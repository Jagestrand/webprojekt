...
<body>
	   <?php
		...
		while($row = $result->fetch_assoc()){
			...
			' alt ='heart face' height='250' width='590'> <img src='". $row['pic']."
			' alt ='heart face' height='250' width='250'> <img src='". $row['pic2']."
			' alt ='heart face' height='250' width='250'>
			<img src='". $row['pic2']."
			' alt ='heart face' height='250' width='250'>
			<img src='". $row['pic2']."
			' alt ='heart face' height='250' width='250'> <img src='". $row['pic']."
			' alt ='heart face' height='250' width='590'> </td></tr><tr><td>Kommentar: " . $row['msg']. 
